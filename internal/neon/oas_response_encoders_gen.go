...
func encodeListProjectBranchLogFieldValuesResponse(response ListProjectBranchLogFieldValuesRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *ProjectBranchLogFieldValuesResponse:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
	...
	case *ProjectBranchLogsInvalidQuery:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(400)
	...
	case *ProjectBranchLogsNotAvailable:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(404)
...
func encodeListProjectBranchLogFieldsResponse(response ListProjectBranchLogFieldsRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *ProjectBranchLogFieldsResponse:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
...
func encodeListProjectMembersResponse(response *ProjectMembers, w http.ResponseWriter, span trace.Span) error {
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
	w.WriteHeader(200)
...
func encodeQueryProjectBranchLogsResponse(response QueryProjectBranchLogsRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *ProjectBranchLogsQueryResponse:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
...
func encodeRemoveProjectMemberRoleResponse(response *ProjectMemberRoleResponse, w http.ResponseWriter, span trace.Span) error {
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
	w.WriteHeader(200)
...
func encodeSendNeonAuthEmailProviderTestResponse(response *SendNeonAuthTestEmailResponse, w http.ResponseWriter, span trace.Span) error {
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
	w.WriteHeader(200)
...
func encodeSetProjectMemberRoleResponse(response *ProjectMemberRoleResponse, w http.ResponseWriter, span trace.Span) error {
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
	w.WriteHeader(200)

...
type Handler interface {
	...
	QueryProjectBranchLogs(ctx context.Context, req *ProjectBranchLogsQueryRequest, params QueryProjectBranchLogsParams) (QueryProjectBranchLogsRes, error)
	...
	SetProjectMemberRole(ctx context.Context, req *SetProjectMemberRoleRequest, params SetProjectMemberRoleParams) (*ProjectMemberRoleResponse, error)
